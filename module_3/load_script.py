...
#----------------------------------------
# Here we set the bucket name
#----------------------------------------
BUCKET_NAME = "hw-3-bucket-2024-data"

#------------------------------------------------------
# GCP Service Account Credentials
# should be in the "cred.json"
# file and assigned to the 'CREDENTIALS_FILE' variable
#------------------------------------------------------
CREDENTIALS_FILE = "/workspaces/data_eng/module_3/cred.json"
#----------------------------------------
# We retrieve the client from the 
# credentials file
#----------------------------------------
...
def download_file(month):
    ...
    try:
        ...
        return file_path
    #----------------------------------------
    # An exception to handle the case 
